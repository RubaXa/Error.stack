var errorStack = (function (exports) {
	...
	*/
	    ...
	    return react.createElement(react.Fragment, null,
	        !activeEntry && react.createElement("div", { className: "error-list-toolbar" },
	            react.createElement("label", { className: "error-list-toolbar-item" },
	                "Group by:",
	                react.createElement("select", { value: groupBy, onChange: function (evt) { setGroupBy(evt.currentTarget.value); } }, GROUP_BY.map(function (v) { return react.createElement("option", { key: v }, v); }))),
	            react.createElement("label", { className: "error-list-toolbar-item" },
	                "Stack:",
	                react.createElement("input", { checked: withStack, type: "checkbox", onChange: function () { setWithStack(!withStack); } })),
	            react.createElement("label", { className: "error-list-toolbar-item" },
	                "URL:",
	                react.createElement("input", { checked: withUrl, type: "checkbox", onChange: function () { setWithUrl(!withUrl); } })),
	            react.createElement("label", { className: "error-list-toolbar-item" },
	                "Detail:",
	                react.createElement("input", { checked: withDetail, type: "checkbox", onChange: function () { setWithDetail(!withDetail); } }))),
	        react.createElement("div", { className: "" + (activeEntry && 'error-list-slider') },
	            activeEntry && react.createElement("div", { className: "error-list-nav-ctrl home", title: "List", onClick: function () { selectEntry(null); } }, "\u21A5"),
	...
	function Tabs(props) {
	    ...
	    return (react.createElement("div", { className: "tabs" },
	        react.createElement("div", { className: "tabs-list" }, props.data.map(function (tab, i) { return react.createElement("div", { className: "tab-title " + (i === idx), onClick: function () { setActiveIdx(i); } },
	...
	**/
	...
	function Stack(props) {
	    ...
	    return (react.createElement("div", { className: "stack" }, error.parsedStack.map(function (frame, i) { return react.createElement(StackFrame, { err: error, frame: frame, prevFrame: error.parsedStack[i - 1], defaultActive: i === 0 }); })));
	}
	function StackFrame(props) {
	    ...
	    return (react.createElement("div", { className: "stack-frame " + (active && 'active'), "aria-disabled": disabled },
	        react.createElement("div", { className: "stack-frame-info flex", onClick: function () { toggleActive(!active); } },
	        ...
	        active && (disabled
	            ? react.createElement("div", { className: "stack-unavailable" },
	                react.createElement("h3", null, "Unavailable to browse source."),
	                react.createElement("div", null, frame.raw))
	            : react.createElement(StackFrameSource, __assign({}, props)))));
	}
	    ...
	    return react.createElement("div", { className: "inspector" },
	        ...
	        activeEntry && react.createElement("div", { className: "inspector-main" },
	            react.createElement("div", { className: "inspector-stack" },
	                react.createElement(Stack, { error: activeRecordEntry === null || activeRecordEntry === void 0 ? void 0 : activeRecordEntry.msg.err })),
	...
	function getTabSource(entries, active, onClick) {
	    return react.createElement("div", { className: "tab-list" }, entries.map(function (rec) {
	        ...
	        return listItem(react.createElement("div", { className: "flex" },
	            ...
	            err.source,
	            ":",
	            err.line), rec.count, disabled ? false : function () { onClick(rec.entry); }, active === rec.entry);
	    }));
	}
